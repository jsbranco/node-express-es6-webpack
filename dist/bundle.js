...
/***/ function(module, exports, __webpack_require__) {
	...
	app.listen(_config2.default.port, '0.0.0.0', function onStart(err) {
	  if (err) {
	    console.log(err);
	  }
	  console.info('==> 🌎 Listening on port %s. Open up http://0.0.0.0:%s/ in your browser.', _config2.default.port, _config2.default.port);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function useColors() {
	  var debugColors = (({"NODE_ENV":undefined}).DEBUG_COLORS || '').trim().toLowerCase();
...
/***/ function(module, exports, __webpack_require__) {
	...
	function isignored(namespace) {
	  ...
	  var str = ({"NODE_ENV":undefined}).NO_DEPRECATION || ''
	...
	function istraced(namespace) {
	  ...
	  var str = ({"NODE_ENV":undefined}).TRACE_DEPRECATION || ''
	...
	Mime.prototype.define = function (map) {
	  for (var type in map) {
	    ...
	    for (var i = 0; i < exts.length; i++) {
	      if (({"NODE_ENV":undefined}).DEBUG_MIME && this.types[exts]) {
...
/***/ function(module, exports) {
	...
	module.exports = {
		"name": "sparkles",
		"version": "1.0.0",
		"description": "Sparkles backend server",
		"main": "index.js",
		"scripts": {
			"start": "node dist",
